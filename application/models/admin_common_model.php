...
class Admin_common_model extends CI_Model{
	...
	$this->db->join("tbl_users as u","u.user_id=utp.user_id");
	...
	public function getallsubcatbycat($categoryid){
	$this->db->select("*");
	$this->db->from("tbl_sub_categories as sc");
	$this->db->join("tbl_categories as c","c.category_id=sc.category_id");
	$this->db->where("sc.category_id",$categoryid);
	$getsubcatbycat=$this->db->get()->result_array();
	return $getsubcatbycat;
	}
	...
	$this->db->select("*");	
	$this->db->from("tbl_vendor as vds");
	...
	public function edit_user($userid){
		...
		$this->db->update('tbl_users as u, tbl_vendor as vds');
		//echo $this->db->last_query();exit;
		return true;
	}
