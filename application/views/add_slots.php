        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li><a href="<?php echo base_url();?>admin/manageslots/<?php echo $vendorid;?>/<?php echo $venueid;?>">Slots</a></li>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>admin/addslots/<?php echo $vendorid;?>/<?php echo $venueid;?>" name="add_slots" method="POST" id="add_slots" class="form-horizontal tasi-form" enctype="multipart/form-data">
						...
						<div class="form-group clearfix">
                            ...
                            <div class="col-sm-5">
							 ...
							 To 
							 <div class="input-group bootstrap-timepicker">
                                        <input type="text" name="to_dte[1]" id="to_dte[1]" value="06:00:00" class="form-control timepicker-24_to">
                                        <span class="input-group-btn">
                                        <button type="button" class="btn btn-default"><i class="fa fa-clock-o"></i></button>
                                        </span>
                             </div>
