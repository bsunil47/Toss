            ...
            <div class="header-section">
                ...
                <div class="logo dark-logo-bg hidden-xs hidden-sm">
                    <a href="index-2.html">
                        ...
                        <span class="brand-name">Toss Venue  Manager</span>
                    </a>
                </div>
...
<!--jquery-ui-->
<script src="<?php echo base_url()?>js/jquery-ui/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url()?>js/flot-chart/flot-spline.js"></script>
...
<script src="<?php echo base_url()?>s/flot-chart/jquery.flot.pie.js"></script>
...
<script src="<?php echo base_url()?>js/flot-chart/jquery.flot.crosshair.js"></script>


<!--earning chart init-->
<script src="<?php echo base_url()?>js/earning-chart-init.js"></script>
...
<!--easy pie chart-->
<script src="<?php echo base_url()?>js/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
<script src="<?php echo base_url()?>js/easy-pie-chart.js"></script>


<!--vectormap-->
<script src="<?php echo base_url()?>js/vector-map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo base_url()?>js/vector-map/jquery-jvectormap-world-mill-en.js"></script>
<script src="<?php echo base_url()?>js/dashboard-vmap-init.js"></script>

<!--Icheck-->
<script src="<?php echo base_url()?>js/icheck/skins/icheck.min.js"></script>
<script src="<?php echo base_url()?>js/todo-init.js"></script>

<!--jquery countTo-->
<script src="<?php echo base_url()?>js/jquery-countTo/jquery.countTo.js"  type="text/javascript"></script>
