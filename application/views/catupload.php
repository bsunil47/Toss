        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <section class="panel">
                <header class="panel-heading">
                    Categories Excel Upload
                </header>
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>admin/catupload" name="upload_vendor" method="POST" id="add_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
						...
						<div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Upload Excel File</label>
                            <div class="col-sm-10">
