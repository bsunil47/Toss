        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>frontend/forgot_changepassword/<?php echo $hashcode;?>" name="changepwd" method="post" id="changepwd" class="form-horizontal tasi-form" enctype="multipart/form-data">
