        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li><a href="<?php echo base_url();?>admin/manageslots/<?php echo $venueid;?>">Venue Slots</a></li>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>admin/editslotdetails" name="add_slots" method="POST" id="add_slots" class="form-horizontal tasi-form" enctype="multipart/form-data">
						...
						<!--	<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b-10 subcategory" name="subcat_id" id="subcat_id">
                                    ...
                                    <option value="<?php echo $getsubcategory->sub_category_id;?>"<?php if($getsubcategory->sub_category_id == $editslotinfo->category_id){?>selected<?php } ?>><?php echo $getsubcategory->sub_category_name;?></option>
									   <?php } ?>
