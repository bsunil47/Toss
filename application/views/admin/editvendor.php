                ...
                <div class="col-md-12">
					...
					<?php } ?> 
                        ...
                        <div class="panel-body no-pad">
                            ...
                            <form id="basic-form" action="<?php echo  base_url() ?>admin/editvendordetails" name="edit_vendor" method="POST" enctype="multipart/form-data">
				...
				<div id="msg"><?php echo  $this->session->flashdata('error');?></div>
						<?php }?>
							...
							<!--<input type="file" id="file-2" name="u_pic" class="file"  multiple=true>-->
                                <input type="file" name="profile_pic" multiple=true><img src="<?php echo base_url()?>images/profiles/<?php echo $editvendor['vendorid']."_user";?>.jpg" name="u_pic" style="width:auto;height:100px;"/>
                            </div>
                        </div>
