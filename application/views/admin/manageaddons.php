...
<div class="tbl-head clearfix">
                            <div class="ColVis">
                              <a class="btn btn-success" href="<?php echo base_url()?>admin/addaddon/<?php echo $getdetails->venue_id;?>"><i class="fa fa-plus"></i>Add Addon</a>  
                            </div>
</div>

                            <table class="datatable-32 table responsive-data-table data-table">
                            <thead>
                            <tr>
								   <th>
                                    S.No
