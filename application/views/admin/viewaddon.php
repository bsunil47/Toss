               ...
               <!--<span class="sub-title">Welcome to Static Table</span>-->
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
						...
						<li><a href="<?php echo base_url();?>admin/listvenue/<?php  echo $getvdetails->vendor_id;?>">Venue List</a></li>
                        <li><a href="<?php echo base_url();?>admin/manageaddons/<?php echo $venueid;?>">Manage Addons</a></li>
