            ...
            <section class="panel">
                <header class="panel-heading">
                    Vendor Subcategory Zipfile Upload
                </header>
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>admin/subcatzip" name="upload_vendor" method="POST" id="add_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
