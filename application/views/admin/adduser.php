            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li><a href="<?php echo base_url();?>admin/venueuserinfo/<?php echo $getdetails->venue_id;?>">Venue Users</a></li>
                        <li class="active">Add Venue User</li>
                    </ol>
                </div>
            </div>
            <!-- page head end-->
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>admin/adduser/<?php echo $this->uri->segment(3);?>" name="add_user" method="POST" id="user_frm" class="form-horizontal tasi-form" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b-10" name="usertype">
                                    ...
                                    <option value="2">Vendor Admin</option>-->
									   <option value="3">Venue Manager</option>
									   <option value="4">Venue staff</option>
