            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li><a href="<?php echo base_url();?>vendors/managepricing/<?php echo $venueid;?>">Pricing</a></li>
...
<!--                    Edit Pricing-->
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>vendors/editprice/<?php echo $priceid;?>/<?php echo $venueid;?>/<?php echo $type;?>" name="edit_price" method="POST" id="edit_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
