            ...
            <section class="panel">
               <header class="panel-heading">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>vendors/addrequestcoins" name="add_coins" method="POST" id="user_frm" class="form-horizontal tasi-form" enctype="multipart/form-data">
                      <?php if($this->session->flashdata('add_coin_success')){?>
						...
						<?php }?>
						 <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b-10" name="venue">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b-10" name="method">
                                    ...
                                    <option value="addon">Addon Facility</option>
