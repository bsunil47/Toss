...
<!--                    Add Pricing-->
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>vendors/addpricing/<?php echo $venueid;?>" name="add_price" method="POST" id="add_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
