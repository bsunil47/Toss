...
<!--                            <header class="panel-heading ">Pricing List
 ...
 <?php if($this->session->flashdata('pricing_success')){ ?>
                     ...
                     <div class="tbl-head clearfix">
                           <div class="ColVis">
                            <a class="btn btn-success" href="<?php echo base_url()?>vendors/addpricing/<?php echo $venue_id;?>"><i class="fa fa-plus"></i>Add Pricing</a>
                           </div>
                           </div>
                            <table class="datatable-12 table responsive-data-table data-table">
                            <thead>
                            <tr>
								<th>S. No</th>
                                <th>Venue Name</th>
