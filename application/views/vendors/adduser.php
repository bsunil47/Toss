            ...
            <div class="page-head">
                <h3 class="m-b-less">
                    Add Venue Manager Or Staff User
                </h3>
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li><a href="<?php echo base_url();?>vendors/managevenuemanagers/<?php echo $venue_id;?>">Mangers and Staff</a></li>
            ...
            <section class="panel">
               <header class="panel-heading">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>vendors/adduser/<?php echo $venue_id;?>" name="add_user" method="POST" id="user_frm" class="form-horizontal tasi-form" enctype="multipart/form-data">
