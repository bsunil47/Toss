...
<!--                                <strong>Venue Information</strong>-->
						  ...
						  <tr>
                                ...
                                <td>
                                    <?php echo $viewvenue['venue_display_name'];?>
									</td>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Venue Image</h4>
                                </div>
                                <div class="modal-body">

                                    <img src="<?php echo base_url()?>images/vendors/<?php echo $viewvenue['vendorid'];?>/<?php echo $viewvenue['venueid'];?>/<?php echo $viewvenue['venue_pic_1'];?>" width="200" height="100"/>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <img src="<?php echo base_url()?>images/vendors/<?php echo $viewvenue['vendorid'];?>/<?php echo $viewvenue['venueid'];?>/<?php echo $viewvenue['venue_pic_2'];?>" width="200" height="100"/>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <img src="<?php echo base_url()?>images/vendors/<?php echo $viewvenue['vendorid'];?>/<?php echo $viewvenue['venueid'];?>/<?php echo $viewvenue['venue_pic_3'];?>" width="200" height="100"/>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <img src="<?php echo base_url()?>images/vendors/<?php echo $viewvenue['vendorid'];?>/<?php echo $viewvenue['venueid'];?>/<?php echo $viewvenue['venue_pic_4'];?>" width="200" height="100"/>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <img src="<?php echo base_url()?>images/vendors/<?php echo $viewvenue['vendorid'];?>/<?php echo $viewvenue['venueid'];?>/<?php echo $viewvenue['venue_pic_5'];?>" width="200" height="100"/>
						  ...
						  <tr>
                                ...
                                <td>
                                    <?php echo $viewvenue['contact_person'];?>
                                </td>
                          </tr>
						  <tr>
                                <td>
					...
					<div class="col-sm-6" style="float:left;">
						...
						<?php for($i=0;$i<count($facilities);$i++){?>
						  <tr>
                                ...
                                <td>
                                    <?php echo $facilities[$i]->facility_name;?>
                                </td>
                          </tr>
						 <?php } ?>
						  </tbody>
