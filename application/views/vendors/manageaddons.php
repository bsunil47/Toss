...
<div class="tbl-head clearfix">
                            <div class="ColVis">
                              <a class="btn btn-success" href="<?php echo base_url()?>vendors/addaddon/<?php echo $venue_id;?>"><i class="fa fa-plus"></i>Add Addon</a>  
                            </div>
</div>

                            <table class="datatable-15 table responsive-data-table data-table">
                            <thead>
                            <tr>
								   <th>
                                    S.No
