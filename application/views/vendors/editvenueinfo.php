                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        <li><a href="<?php echo base_url();?>vendors/dashboard">Home</a>
                         ...
                         <li><a href="<?php echo base_url();?>vendors/managevenues">Venues</a>
                        </li>
                ...
                <div class="col-md-12">
					...
					<?php } ?> 
                        ...
                        <div class="panel-body no-pad">
                            ...
                            <form id="basic-form" action="<?php echo  base_url() ?>vendors/editvenuedetails" name="edit_vendor" method="POST" enctype="multipart/form-data">
