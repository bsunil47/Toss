            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li><a href="<?php echo base_url();?>vendors/manageaddons/<?php echo $venueid;?>">Addons</a></li>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <?php if($this->session->flashdata('addon_error')){ ?>
						...
						<?php } ?>
                    <form action="<?php echo  base_url() ?>vendors/addaddon/<?php echo $venueid;?>" name="add_addon" method="POST" id="cat_frm" class="form-horizontal tasi-form">
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Select Addon Facility</label>
                            <div class="col-sm-10">
                                <select name="addon" id="facility" class="form-control m-b-10" onchange="getvalone(this.value)" >
