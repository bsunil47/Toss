				...
				<div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                           ...
                           <div class="ColVis">
                            <a class="btn btn-success" href="<?php echo base_url()?>vendors/addimages/<?php echo $venueid;?>"><i class="fa fa-plus"></i>Add Image</a>  
                           </div>
                           </div>
						   <!-- class="responsive-data-table" -->
                            ...
                            <tr>
                                ...
                                <td width="25%" style="text-align: center;">
                                    <a href="<?php echo base_url();?>vendors/deleteimages/<?php echo $venueid;?>/<?php echo $vendorid;?>/<?php echo $imcount;?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
								</td>
