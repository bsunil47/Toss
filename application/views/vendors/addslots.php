...
<div class="page-head">
    ...
    <div class="state-information">
        <ol class="breadcrumb m-b-less bg-less">
            ...
            <li><a href="<?php echo base_url(); ?>vendors/manageslots/<?php echo $venueid; ?>">Slots</a></li>
        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php } ?>
                    <form action="<?php echo base_url() ?>vendors/addslots/<?php echo $venueid; ?>" name="add_slots" method="POST" id="add_slots" class="form-horizontal tasi-form" enctype="multipart/form-data">
