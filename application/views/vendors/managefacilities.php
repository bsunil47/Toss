...
<a class="btn btn-success" style="float:right;" href="<?php echo base_url()?>vendors/addfacility/<?php echo $venue_id;?>"><i class="fa fa-plus"></i>Add Facility</a>
                            ...
                            <tr>
								...
								<a href="<?php echo base_url()?>vendors/updatefstatus/<?php echo $getfacility->facility_id;?>/<?php echo $getfacility->status;?>/<?php echo $getfacility->venue_id;?>" style="color:black;"><i class="fa fa-remove" title="Inactive"></i></a>
								<?php }else{?>
								<a href="<?php echo base_url()?>vendors/updatefstatus/<?php echo $getfacility->facility_id;?>/<?php echo $getfacility->status;?>/<?php echo $getfacility->venue_id;?>" style="color:black;"><i class="fa fa-check" title="Active"></i></a>
								<?php }?>
                             <a href="<?php echo base_url()?>vendors/viewfacility/<?php echo $getfacility->facility_id;?>/<?php echo $getfacility->venue_id;?>" style="color:black"><i class="fa fa-eye" title="View"></i></a>
								<!--class="label label-danger"-->
								
								<!--class="btn btn-success btn-xs"-->
								<a href="<?php echo base_url() ?>vendors/editfacilityinfo/<?php echo $getfacility->facility_id;?>/<?php echo $getfacility->venue_id;?>" style="color:black"><i class="fa fa-pencil" title="Edit"></i></a>
