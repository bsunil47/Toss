            ...
            <div class="page-head">
                <h3 class="m-b-less">
                    Edit Venue Manager or Staff Information
                </h3>
...
<!--                    Form Elements-->
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>vendors/edituserdetails" name="add_user" method="POST" id="user_frm" class="form-horizontal tasi-form" enctype="multipart/form-data">
                      <?php if($this->session->flashdata('add_user_success')){?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="venuename" id="venuename" class="form-control" value="<?php echo $edituserdetails->venue_display_name;?>" readonly="readonly">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="check-box">
                        <label>
                            <input type="radio" <?php if($edituserdetails->gender == 1) {?> checked="checked"<?php } ?> id="optionsRadios1" name="gender" value="1">
                            Male
                        </label>
                    
                    
                        <label>
                            <input type="radio" <?php if($edituserdetails->gender == 0) {?>checked="checked"<?php } ?> id="optionsRadios2" name="gender" value="0">
                            Female
                        </label>
