            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>vendors/changepassword" name="changepwd" method="POST" id="changepwd" class="form-horizontal tasi-form" enctype="multipart/form-data">
