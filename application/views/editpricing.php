...
<!--                    Edit Pricing-->
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>admin/editprice/<?php echo $priceid;?>/<?php echo $venueid;?>" name="edit_price" method="POST" id="edit_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-10">
                               <select name="ptype" id="ptype" onchange="getval(this.value)" class="form-control m-b-10">
									...
									<option value="5" <?php if($getdetails->price_type==5){?> selected <?php } ?>>Sub Subcategory</option>
									<option value="6" <?php if($getdetails->price_type==6){?> selected <?php } ?>>Slot</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
								...
								<?php if($getdetails->price_type==5){?>
                                     <option value="">-Select Sub Subcategory-</option>
                                  <?php  foreach($subsubcategories as $subsubcategory){?>
                                     <option value="<?php echo $subsubcategory->sub_sub_category_id;?>" <?php if($getdetails->base_type_id==$subsubcategory->sub_sub_category_id){?>selected=""<?php }?>><?php echo stripslashes($subsubcategory->sub_sub_category_name);?></option>
                                
                                  <?php  }
                                }?>
								<?php if($getdetails->price_type==6){?>
                                     <option value="">-Select venue-</option>
                                  <?php  foreach($slotvenues as $slotvenue){?>
                                     <option value="<?php echo $slotvenue->venue_id;?>" <?php if($getdetails->base_type_id==$slotvenue->venue_id){?>selected=""<?php }?>><?php echo stripslashes($slotvenue->venue_display_name);?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="adamount" id="adamount"  readonly="" value="<?php echo $getdetails->amount-$getdetails->discount_amount;?>">
...
function getval(v){
        if(v=='1'){
        var url='<?php echo base_url()?>vendors/getmembership';
    ...
    var url='<?php echo base_url()?>vendors/getcategories';
    ...
    var url='<?php echo base_url()?>vendors/getsubcategories';
    ...
    var url='<?php echo base_url()?>vendors/getfacilities';
...
var url='<?php echo base_url()?>vendors/getvenues';
...
function getdiscount(d){
 ...
 function getamountchange(ad){
	var d=document.getElementById('damount').value;
    var dis=parseInt(ad)-parseInt(d);
	if (isNaN(dis) == true){
       dis=ad;
    }else{
