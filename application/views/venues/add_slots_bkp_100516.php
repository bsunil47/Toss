                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/addslots" name="add_slots" method="POST" id="add_slots" class="form-horizontal tasi-form" enctype="multipart/form-data">
						...
						<?php if($this->session->flashdata('error_slot')){ ?>
                            ...
                            <div class="col-sm-10" style="color:red;"><?php echo "<strong>".$this->session->flashdata('error_slot')."</strong>";?>
							...
							<div class="form-group clearfix">
                            <label class="col-sm-2 col-sm-2 control-label"> </label>
                            <div class="col-sm-10" style="color:red;"><?php echo "<strong>".$this->session->flashdata('error_slot_time')."</strong>";?>
