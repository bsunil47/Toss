            <!-- page head start-->
            <div class="page-head">
                <h3 class="m-b-less"> Edit Staff</h3>
            ...
            <div class="col-lg-12">
            <section class="panel">
               <!--<header class="panel-heading">Edit Staff</header>-->
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/editstaffdetails" name="add_user" method="POST" id="user_frm" class="form-horizontal tasi-form" enctype="multipart/form-data">
                      <?php if($this->session->flashdata('add_user_success')){?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="u_email" value="<?php if(isset($edituserdetails->email)){echo $edituserdetails->email;}?>" readonly="readonly">
