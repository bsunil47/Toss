            <!-- page head start-->
            <div class="page-head">
                <h3 class="m-b-less">Add Staff </h3>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/addstaff" name="add_staff" method="POST" id="user_frm" class="form-horizontal tasi-form" enctype="multipart/form-data">
