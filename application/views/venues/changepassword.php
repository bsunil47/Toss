            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/changepassword" name="changepwd" method="POST" id="changepwd" class="form-horizontal tasi-form" enctype="multipart/form-data">
                    				
						<div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Current Password</label>
                            <div class="col-sm-10">
                                <input type="password" class="form-control" name="c_pwd" value="<?php if(isset($_POST['c_pwd'])){echo $_POST['c_pwd'];}else{echo "";}?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="password" class="form-control" name="n_pwd" value="<?php if(isset($_POST['n_pwd'])){echo $_POST['n_pwd'];}else{echo "";}?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="password"  class="form-control" name="c_n_pwd" value="<?php if(isset($_POST['c_n_pwd'])){echo $_POST['c_n_pwd'];}else{echo "";}?>">
