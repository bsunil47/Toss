...
<body class="sticky-header">
    ...
    <section>
        <!-- sidebar left start-->
        <?php include_once("includes/venues_leftmenu.php");?>
        <!-- sidebar left end-->
        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/zipfiles" name="upload_vendor" method="POST" id="add_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
