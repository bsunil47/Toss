            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                       ...
                       <li><a href="<?php echo base_url();?>venues/manageaddons">Addons</a></li>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <?php if($this->session->flashdata('addon_error')){ ?>
						...
						<?php } ?>
                    <form action="<?php echo  base_url() ?>venues/addaddon" name="add_addon" method="POST" id="cat_frm" class="form-horizontal tasi-form">
