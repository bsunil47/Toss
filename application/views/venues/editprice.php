...
<!--                    Edit Pricing-->
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/editprice/<?php echo $priceid;?>/<?php echo $venueid;?>/<?php echo $type;?>" name="edit_price" method="POST" id="edit_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
