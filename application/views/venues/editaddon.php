            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        ...
                        <li><a href="<?php echo base_url();?>venues/manageaddons">Adddons</a></li>
...
<!--                    Edit Pricing-->
                ...
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/editaddon/<?php echo $venueid;?>/<?php echo $base_type_id;?>/<?php echo $base_type;?>" name="edit_addon" method="POST" id="edit_price" class="form-horizontal tasi-form" enctype="multipart/form-data">
