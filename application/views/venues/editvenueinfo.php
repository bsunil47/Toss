            <!-- page head start-->
            <div class="page-head">
                <h3 class="m-b-less">Edit Venue Manager Details</h3>
                <!--<span class="sub-title">Welcome to Static Table</span>-->
                <div class="state-information">
                    <ol class="breadcrumb m-b-less bg-less">
                        <li><a href="<?php echo base_url();?>venues/dashboard">Home</a></li>
                        <!--<li><a href="#">Form</a></li>-->
                        <li class="active">Edit Venue Manager Details</li>
                    </ol>
                </div>
            </div>
            <!-- page head end-->
            ...
            <div class="col-lg-12">
            <section class="panel">
                <!--<header class="panel-heading">Edit Details</header>-->
                <div class="panel-body">
                    <form action="<?php echo  base_url() ?>venues/editvenuedetails" name="add_user" method="POST" id="user_frm" class="form-horizontal tasi-form" enctype="multipart/form-data">
